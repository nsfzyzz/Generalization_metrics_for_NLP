...
print("Using modified weightwatcher")
...
#        return "{} v{} by {}\n{}\n{}".format(__name__, __version__, __author__, __description__, __url__)
    ...
    def apply_fit_powerlaw(self, ww_layer, params=DEFAULT_PARAMS):
        ...
        alpha, xmin, xmax, D, sigma, num_pl_spikes, best_fit, exponent, sigma_var = self.fit_powerlaw(evals, xmin=xmin, xmax=xmax, plot=plot, 
                                                layer_name=layer_name, layer_id=layer_id, sample=sample, sample_size=sample_size, 
                                                savedir=savedir, fix_fingers=ff, distribution=distribution)
        ...
        if distribution=="truncated_power_law" or distribution=="exponential":
            ww_layer.add_column('exponent', exponent)
        elif distribution=="lognormal":
            ww_layer.add_column('sigma_var', sigma_var)
    ...
    def analyze(self, model=None, layers=[], min_evals=0, max_evals=None,
                ...
                fix_fingers=False, distribution="power_law"):
        """
        ...
        fix_fingers: (fix fingers)
            ...
            Can be very slow.
        distribution:
            Fit the distribution using various pdfs.
...
#     def pytorch_norm_fix(self, W, N, M, rf_size):
    ...
    def fit_powerlaw(self, evals, xmin=None, xmax=None, plot=True, layer_name="", layer_id=0, sample=False, sample_size=None, 
        ...
        return alpha, xmin, xmax, D, sigma, num_pl_spikes, best_fit, exponent, sigma_var
